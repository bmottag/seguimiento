...
$(function(){ 
	$(".btn-success").click(function () {	
            ...
            $.ajax ({
                type: 'POST',
				url: base_url + 'admin/cargarModalParametros',
		...
		<div class="col-md-12">
			<div class="panel panel-primary">
				<div class="panel-heading">
					...
					<i class="fa fa-gear fa-fw"></i> CONFIGURACIONES - PARAMETROS DEL SISTEMA
					</h4>
				</div>
			</div>
		</div>
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-default">
				<div class="panel-heading">
					<i class="fa fa-gear"></i> PARAMETROS DEL SISTEMA
				</div>
...
?> 
				...
				?>				
					<table width="100%" class="table table-striped table-bordered table-hover" id="dataTables">
						<thead>
							<tr>
								<th class="text-center">Fecha votaciones</th>
								<th class="text-center">Hora inicio votaciones</th>
								<th class="text-center">Hora fin votaciones</th>
