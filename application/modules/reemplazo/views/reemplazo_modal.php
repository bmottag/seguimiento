<script type="text/javascript" src="<?php echo base_url("assets/js/validate/reemplazo/reemplazo.js"); ?>"></script>
<script type="text/javascript" src="<?php echo base_url("assets/js/validate/reemplazo/ajaxReemplazo.js"); ?>"></script>

<div class="modal-header">
	<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
	<h4 class="modal-title" id="exampleModalLabel">Reemplazo
	</h4>
</div>
...
<div class="modal-body">
	...
	<form name="form" id="form" role="form" method="post" >
		<input type="hidden" id="hddId" name="hddId" value="<?php echo $information?$information[0]["id_reemplazo"]:""; ?>"/>
		...
		<div class="row">
			<div class="col-sm-6">
				<div class="form-group text-left">
					<label for="type" class="control-label">Reemplazado : *</label>
					<select name="reemplazado" id="reemplazado" class="form-control" >
						<?php if($information){ ?>
						<option value=''>Select...</option>
							<option value="<?php echo $information[0]["id_reemplazado"]; ?>" selected><?php echo $information[0]["id_reemplazado"]; ?></option>
						<?php } ?>
					</select>
				</div>
			</div>
			...
			<div class="col-sm-6">
				<div class="form-group text-left">
					<label for="type" class="control-label">Reemplazante : *</label>
					<select name="reemplazante" id="reemplazante" class="form-control" >
						<?php if($information){ ?>
						<option value=''>Select...</option>
							<option value="<?php echo $information[0]["id_reemplazante"]; ?>" selected><?php echo $information[0]["id_reemplazante"]; ?></option>
						<?php } ?>
					</select>
				</div>
			</div>
